...
- Tukar baris pertama $\left(R_1\right)$ dengan baris kedua $\left(R_2\right)$ agar elemen pertama pada baris pertama menjadi 1:
$$
\left[\begin{array}{ccc|c}
1 & -1 & 2 & 3 \\
2 & 1 & -1 & 1 \\
...
- Bagi baris kedua $\left(R_2\right)$ dengan 3:
$$
\left[\begin{array}{ccc|c}
1 & -1 & 2 & 3 \\
...
- Bagi baris ketiga $\left(R_3\right)$ dengan $\frac{10}{3}$ :
$$
\left[\begin{array}{ccc|c}
1 & 0 & \frac{1}{3} & \frac{4}{3} \\
0 & 1 & -\frac{5}{3} & -\frac{5}{3} \\
...
- Gunakan operasi baris:
- $\quad R_1=R_1-\frac{1}{3} R_3$
- $\quad R_2=R_2+\frac{5}{3} R_3$
